...
$(".gallery").each((i, el) => {
  $(el).click(()=> {
    $(el).parent().addClass("lg:fixed lg:z-[100] lg:inset-0 lg:w-[80%] lg:mx-auto lg:px-4")
    $("#gallery_overlay").removeClass("lg:hidden")
    $("body").addClass("lg:overflow-hidden")
    $("#gallery_close").removeClass("lg:hidden")
  })
  $("#gallery_close").click(()=> {
    $(el).parent().removeClass("lg:fixed lg:z-[100] lg:inset-0 lg:w-[80%] lg:mx-auto lg:px-4")
